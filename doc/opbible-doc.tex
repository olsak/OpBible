...
Příkaz \`\town` `<x-posun> <y-posun>` vloží do místa podle <x-posun>,
<y-posun> kolečko. Barva kolečka, jeho velikost a tloušťka a barva obrysové
čáry se řídí parametry definovanými v `\townparams`. Implicitní parametry
jsou
\begtt
\def\townparams{    
