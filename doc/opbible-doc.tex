...
\`\input {vars.tex}` reads the configuration concerning the translation variants
...
We are formatting the text of the book ofDaniel, in the BBE translation, 
...
crop marks. If for some reason you want to do it yourself, you can use the macro `cropmarks.tex` which is part of \ulink[http://petr.olsak.net/optex/optex-tricks.html]{\OpTeX/}.
