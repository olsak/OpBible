...
\ccd Ježíš
Bohu Syn
\+ Život: Rodokmen  <Mt 1:1-17>; <Lk 3:21-37>.
   Narození  <Mt 2:1-12>; <Lk 2:1-40>. Útěk do Egypta
   <Mt 2:13-23>.
\+ Zázraky: Uzdravení <Mt 4:5> ...
\+ Učení: ... <Mt 6:7> ...
\+ Podobenství: ... ... ...

\ccd \x/Cýros/
\+ Život: <Da 1:8-13>
\+ Setkání: \x/Daniel/ <Da 1:9>, \x/Balsazar/ <Da 1:10> ...
\endtt

Each single concordance begins with the command `\ccd` followed by the
...
includes additional text of the concordance. The command
...
Concordances must be divided by empty lines in the source file. You need not
to write them in the alphabetically order becuase the sortig is done by
\TeX.

You can use words in more translation variats. For example `\x/Cýros/`
is printed as Cýros in the BKR variant but as Kýros in the CEP variant. It
means that it is sorted before Jesus in BKR but after Jesus in CEP.
