...
\watchout
When you use introduction file that is not connected to a particular biblical book (e.g.,
Introduction to Pentateuch) and such file should
come before the first book of the `\printedbooks` list (usually Genesis), the
