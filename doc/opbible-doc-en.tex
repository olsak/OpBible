...
The \`\ww` also accepts the parameters in the form `{"}` like the \`\vdef` does it. The value of previous parameter is used instead of `{"}`.
...
see {\Blue Phlm 3} and it refers to verse 3 of the Philemon, not to chapter~3. On the other hand, \code{see <Gen 3>} prints see {\Blue Gen 3} and refers to the chapter 3 of the Genesis. It is the reference to whole chapter, as described in the section~\ref[tochapter].
...
The same can be applied to the chapreter range, as shown in the example in the section~\ref[rochapter].
...
is incorrect. However, when\TeX/ runs first time, all
