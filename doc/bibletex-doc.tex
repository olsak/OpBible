...
Místo `<parametr-B>`, `<parametr-C>` atd. příkazu `\wdef` může být znak `"`,
který značí, že daný parametr je stejný jako předchozí
parametr. Tato vlastnost je analogická jako u příkazu `\vdef`.
...
Například `<"První kniha Samuelova"_1S 1:1>` vytiskne pouze text
