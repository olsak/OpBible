...
%  \LMfonts \sans \setfontsize{at10pt}\rm
  ...
  \puttext 80mm 40mm {\c[10/\kern1pt\pdfrotate{-3}]{Tady je text podél křivky}}
  \puttext 120mm 80mm {<"\c[-30/\kern1pt\pdfrotate{4}]{Tady je jiný text}"_Da 1:1>}
}
...
Mnoho badatelů datuje vznik knihy mezi 170 a 165 př.Kr., do doby vlády Antiocha IV. Epifana, dávno poté, co žil prorok Daniel (tzv. \uv{makabejské} datování, ssrv. čl.~<"Kdo byl \x/Darius/ Médský?"_6>a na str.~\pg). 
