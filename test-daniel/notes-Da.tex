...
\Note 3:12 {Sidrach, Mizael a Abednego} \dopsat %\x//(<"">)
...
\Note 3:25 {}={syna bohů} Fráze, použitelná pro různé druhy nebeských bytostí; zde je míněn <"\uv{anděl}" 28>.
...
\Note 3:32 {Bůh nejvyšší}={Nejvyšší Bůh} Viz <"poz." 2:47>n;  <3:26>n a <3:28>.

\Note 3:33 {veliká}={veliká ... mocné}  \x/Nabuchodonozor/ovo vyznání opakovaně připomíná hlavní téma knihy, absolutní svrchovanost Boží ("srv." <4:33-34> a <"pozn." 7:1-12:13>).

\Note 4:3-4 {} Viz <"pozn." 1:20> a <2:2>.

\Note 4:8 {Baltazar} <"Viz pozn." 1:7>.

\Note 4:9 {duch}={duch svatých bohů} Ačkoliv \x/Nabuchodonozor/ vyjadřuje svůj respekt k \x/Daniel/ovi pohanskou terminologií, dotýká se pravdy: Přítomnost Ducha Svatého má na člověka nepřehlédnutelný účinek; v \x/Daniel/ově případě je to vhled do Božích neproniknutelných tajemství, dar, který o mnoho později obdržel i apoštol Pavel a církev  (<1Kor 2:6-16>).

\Note 4:9 {nic}={žádné tajemství ti nedělá potíže}  <"Viz" 2:47> a <"pozn." 2:19>n.

\Note 4:10 {strom} Ezechiel 31 také líčí království metaforou vysokého stromu. Podobné obrazy vidíme např. v <Ž 1:3>; <Ž 37:35>; <Ž 52:10>; <Ž 92:13-14>; <Jr 11:16-17>; <Jr 17:8> nebo <Mt 13:32>. 

\Note 4:13 {svatý}  \x/Nabuchodonozor/ připouští, že viděl se svatou nebeskou bytost. Víra v podobné bytosti byla na Starém Blízkém Východě běžná a koreluje s biblickým přesvědčením, že Bůh zasahuje do pozemských záležitostí, mnohdy skrze své služebníky anděly.

\Note 4:16 {}={srdce lidské} Je zřejmé, že se jedná o člověka, nikoliv strom. Srv. <"pozn." 4:19>.

\Note 4:16 {srdce zvířecí} 
     \x/Nabuchodonozor/  byl postižen mentální poruchou zvanou lykantropie 
     (z řeckého {\em lukos} -- vlk a {\em anthropos} -- člověk), 
     při níž  se člověk chová jako vlk nebo i jiné zvíře (<33>; viz též <"pozn."4:33>n. 
     \dopsat

\Note 4:16 {sedm let} 
     Sedm období neurčené délky (srv. vv. <20> a <22>). Většina interpretů se shoduje na závěru, že 
     {\em \x/léto/} znamená jeden rok. Verš <30> naznačuje, že doba byla delší než den, týden či měsíc.

\Note 4:21 {}={Ten strom jsi ty} Pointa vyprávění, podobná Nátanově napomenutí Davida (<2Sa 14:7>), znamená přímou aplikaci pro \x/Nabuchodonozor/a.

\Note 4:25 {}={zaženou ... s polní zvěří ... spásat porost}  \x/Daniel/ opakuje po nebeském poslu (<13>) popis mentální poruchy, kterou Hospodin postihne nejmocnějšího muže světa. Podobnými symptomy občas trpěl panovník Království Velké Británie a Irska Jiří III. nebo Ota I. Bavorský. Viz <"pozn." 13>n.

\Note 4:25 {}={dokud nepoznáš} Záměrem \x/Nabuchodonozor/ova ponížení bylo přimět ho uznat Boží svrchovanost. 

\Note 4:26 {království tvé tobě zůstane} \x/Daniel/ ujišťuje \x/Nabuchodonozor/a, že poté, co uzná Boží svrchovanost, ani izolace dlouhodobou duševní poruchou ho nepřipraví o království.

\Note 4:26 {nebesa}={vládnou nebesa}  První výskyt v Písmu, kdy výraz \uv{nebesa} je použit jako synonymum pro Boha. Srv. např.  <Mt 5:3> s <Lk 6:20>.

\Note 4:37 {krále nebeského} Toto jedinečné slovní spojení shrnuje téma kapitoly: vládu Boha z nebes (srv. <23> a <"pozn." 23>n). 

\Note 4:33 {bylinu jako vůl jedl}
     Vzhledem k tomu, že  se \x/Nabuchodonozor/ projevoval rysy charakteristickými pro býložravce,
     je jeho mentální porucha někdy nazývána {\it boantropií.\/} Viz <"pozn." 13>.
...
%     BKR                       PSP                         CSP                                 CEP                                         B21                                    SNC
\wdef {nebo jest mnohých dnů}    {neboť je na mnohé dni}      {je totiž na velmi dlouho}      {neboť se uskuteční za mnoho dnů}      {protože se týká vzdálené budoucnosti}      {protože se týká vzdálené budoucnosti}    
