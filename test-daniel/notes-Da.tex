...
\wdef 1:1  
    {Nabuchodonozor král Babylonský}  %BKR
...
\Note 1:2 {vydal Pán} Porážka Izraele Babylónem není vysvětlitelná jen pouhou vojenskou a politickou analýzou oné doby. Bůh vždy jednal svrchovaně v záležitostech národů. Babylóňany použil jako nástroj potrestání svého vlastního lidu za porušení smluvních závazků (<2Kr 17:15>; <2Kr 17:18-20>; <2Kr 21:12-15>; <2Kr 24:3-4>).
...
\wdef 1:7
    ...
    {Beltšasar}={Beltšasar, Chananjášovi Šadrak, Míšaelovi Méšak a Azarjášovi Abed-nego} %CEP
    {Baltazar}={Baltazar, Chananiášovi Šadrach, Mišaelovi Mešach a Azariášovi Abednego}  %B21 
    {Beltšasarem}={Beltšasarem, Chananjáše Šadrakem, Míšaele Méšakem a Azarjáše Abed-negem}  %SNC
...
\wdef 1:15  
    {tváře jejich byly krásnější}  %BKR
...
\wdef 2:2
    {mudrce, a hvězdáře i kouzedlníky a Kaldejské}  %BKR
...
\Note 2:19 {věc tajná}={tajemství} Skryté věci jsou u Hospodina (<Dt 29:29>). Jsou {\em transcendentní} --- nepoznatelné, pokud nejsou zjeveny. Později je tentýž výraz použit pro označení Božích skrytých záměrů s dějinami světa (\<4:6>). 
%%%%% Příklad do dokumentace. Zkontrolovat Dt 29:29, někde je to 29:28

\wdef 2:21  
    {ssazuje krále, i ustanovuje krále}  %BKR
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\wdef 2:28
    {jest Bůh na nebi, kterýž zjevuje tajné věci}  %BKR
...
\wdef 2:34
    {kámen, kterýž nebýval v rukou}  %BKR
...
\Note 2:34 {kámen, kterýž nebýval v rukou} Na rozdíl od ostatních království, budovaných lidmi, toto vystaví Bůh sám. Zde  je kámen asociován s Kristovým královstvím    (srv. <1Kor 10:4> a <"jeho pozn." 1Kor 10:4>n).
%%%%% Co s tím? Jak napsat "a jeho poznámku", aby to byl link, ale už neopakoval čísla? Šlo by, aby nebyl uveden ani verš?

\wdef 2:38
    {hlava zlatá}={hlava zlatá ... království pak čtvrté}  %BKR
...
\Note 2:44 {na věky nebude zkaženo} Podobně jako i jiní proroci, \x/Daniel/ hovoří o království, které Bůh založí po návratu z exilu jako permanentní (srv. např. <Iz 9:7>; <Jl 2:26-27> či <Am 9:15>). NZ učí, že toto království začalo Kristovým prvním příchodem a dosáhne svého dovršení jeho slavným návratem (viz článek <"Království Boží u" Mt 4> na str. \ref[Království Boží]). 
...
\wdef 2:47
    {Bůh bohů a Pán králů}  %BKR
    {Bůh bohů a Pán králů} %PSP
    {bůh bohů a pán králů}  %CSP
    {Bůh bohů a Pán králů} %CEP
...
\wdef 3:8
 ...
 Zde však výraz \uv{Chaldejci} indikuje národnost, nikoliv funkci. Chaldejci shlíželi spatra na Židy z rasově-etnických antisemitských předsudků (<"srv." 12>; <Est 3:5-6>). Privilegovaná pozice \x/Sidrach/a, \x/Mizael/a a  \x/Abedneg/a znásobila nevraživost Chaldejců vůči nim (\<12>).

\Note 3:12 {Sidrach}={\x/Sidrach/, \x/Mizach/ a \x/Abedneg/o} Viz <"pozn." 1:7>n a <2:49>n. 

\wdef 3:15  
    {který jest ten Bůh}  %BKR
    {kdo je onen Bůh} %PSP
    {kdo je bůh}  %CSP
    {kdo je ten Bůh} %CEP
    {který bůh}  %B21 
...
\wdef 4:23
    {své království znovu dostaneš}   %BKR
...
\Note 7:11-12 {}  Určitá lhůta je ponechána předchozím královstvím, jejichž obyvatelé i se svými zvyklostmi byli absorbovány následujícími říšemi. V kontrastu s tím je vyjádřen důraz na totální zkázu čtvrtého království. Srv. <"pozn." 3>n
...
\Note 7:27 {lidu svatých} Viz  <"pozn." 18>n.
 ...
 \Note 7:28 {Daniel}={vyděšen} Myšlenky o Izraeli, který nepřestal0 hřešit ani v zajetí a vykoledoval si tak sedminásobný trest pod vládou cizích království   (srv. <"pozn." 9:11>n),
...
\wdef 9:27 {učiní konec oběti zápalné i oběti suché} {bude zastavovat oběti, i oběť daru} {ukončí obětní hod i přídavnou oběť} {zastaví obětní hod i oběť přídavnou} {obětem i darům konec učiní} {všechny oběti ztratí smysl}
...
\wdef 9:27
    {poplénění hubící}   %BKR
    {k dovršení ohavností}   %PSP
    {na křídle ohavnostní bude pustošící}   %CSP
    {ohyzdné modly}   %CEP
...
\wdef 10:1  
    {Léta třetího Cýra krále Perského}   %BKR
...
\wdef 10:2 {kvílil} {upadl v truchlivost} {truchlil} {truchlil} {držel}={držel ... smutek} {smutný}
\Note 10:2 {kvílil} Pravděpodobný důvod \x/Daniel/ova zármutku byl stav Jeruzaléma (<Neh 1:4>; <Iz 61:3-4>; <64:8-12>; <66:10>).

\wdef 10:5 {muž}={muž ... oděný v roucho lněné} 
...
\wdef 10:12  
    {jsi přiložil srdce své, abys rozuměl}   %BKR
...
%\wdef 11:1  
%    {léta prvního Daria Médského}   %BKR
...
\wdef 11:2
    {zbohatne bohatstvím velikým}   %BKR
    {bude bohatnout}   %PSP
    {zbohatne}   %CSP
    {bohatství}   %CEP
    {mnohem bohatší}   %B21
...
\wdef 11:2
    {vzbudí všecky proti království Řeckému}   %BKR
...
\wdef 11:5  
    {jedno z jeho knížat, a mocnější bude nad něho}   %BKR
    {z jeho knížat, a bude sílit nad něho}   %PSP
    {jeden z jeho velitelů a ten zesílí nad něho}   %CSP
    {jeden z jeho velitelů se zmůže víc než on}   %CEP
...
\wdef 11:7  
    ...
    {povstane}={povstane z výstřelku kořenů jejích}   %SNC
...
\wdef 11:7
    {udeří na pevnost krále půlnočního}   %BKR
...
\wdef 11:9
    {přijde}={král půlnoční přijde ... král polední, a navrátí se do země své}   %BKR
...
\Note 11:10 {jeho synové} Seleukos III. Keranus (226--223 př.Kr) a Antiochos III. Megás (223--187 př.Kr.).

\wdef 11:10  
    {válčiti budou, a seberou množství vojsk velikých}   %BKR
...
\wdef 11:13  
    {sšikuje množství větší než prvé}   %BKR
...
\wdef 11:17  
    {ona nedostojí aniž bude držeti s ním}   %BKR
...
\Note    11:22 {vůdce}={i ten vůdce ... smlouvu} %doplnit \wdef
...
\wdef 11:30
    {přijdou proti němu lodí Citejské}  %BKR
...
\wdef 11:30
    {zlobiti se bude proti smlouvě svaté}   %BKR
...
\wdef 11:32
    {lid pak, kterýž zná Boha svého}   %BKR
...
\wdef 11:35
    {do času jistého}={do času jistého ... až do času uloženého}   %BKR
...
\wdef 11:36
    {až do vykonání prchlivosti}   %BKR
...
\wdef 11:40
    {dokonání pak toho času}   %BKR
    {v době konce}   %PSP
    {v čase konce}   %CSP
    {V době konce}   %CEP
    {V posledním čase}   %B21
    {V době konce}   %SNC
\Note 11:40 {dokonání pak toho času}  \x// (<"">) (<"">) 
    Viz <"pozn." 8:17>n.
...
\wdef 11:45  
    {když přijde k skonání svému, nebude míti žádného spomocníka}   %BKR
...
\wdef 12:7
    {času}={času ... časích, i půl času}  %BKR
    {času}={času ... časům a polovině} %PSP
    {době, dobám a polovině}  %CSP
    {času, časům a polovině}%CEP
