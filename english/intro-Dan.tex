...
\insertBot {The empires of Daniel's distant visions}[mapa](){\inspic{mapa-crop.pdf}
  \Heros \cond \setfontsize{at 9pt}\rm
\puttext -1.85mm 112mm {\vtop{\hsize7.1cm \baselineskip10pt \noindent
...
\puttext 52mm 21mm {\vtop{\hsize9.2cm \baselineskip10pt \noindent The Holy Land was under the rule of the Ptolemaic dynasty (i.e. Egypt) from 323 to 198 BC; then under the rule of the Seleucids (i.e. Syria) from 198 to 142 BC. Their internecine strife is foreshadowed by <Dan 11:2-45>.  
...
%  \LMfonts \sans \setfontsize{at9pt}\rm
  ...
  \puttext 55mm 52mm {<"Dan 11:5 (\uv{king of the south})"_Dan 11:5>}
  \puttext 55mm 62mm {<"Dan 11:6 (\uv{king of the north})"_Dan 11:6>}
  \puttext 88mm 56mm {<"Dan 3:1"_Dan 3:1>}
  ...
  \puttext 115mm 34mm {<"Gen 11:31"_Gen 11:31>}
  \Heros \setfontsize{at 9pt}\rm
  \puttext 51mm 52mm {\c[-40/\kern1pt\pdfrotate{0}]{Jerusalem}}
  ...
  \puttext 62mm 77mm {\c[10/\kern7pt\pdfrotate{-1}]{THE SELEUCIDS}}
  \puttext 2mm 39mm {\c[0/\kern3pt\pdfrotate{2.5}]{THE PTOLEMIES}}
  \Heros \setfontsize{at 11pt}\rm
  \puttext 130mm 50mm {\c[-40/\kern4pt\pdfrotate{-1}]{ELAM}}
  \puttext 97mm 49.5mm {\c[-25/\kern4pt\pdfrotate{1}]{SINEAR}}
...
For example, Jesus refers to Daniel's prediction of \uv{exact abomination} (see \<"note on" 9:17>n; \<11:31>n; \<12:11>n),
