...
He is first mentioned in \<5:31>. Some (mainly critical, i.e., liberal) theologians, advocating a late (so-called \uv{Maccabean}) dating of the book of \x/Daniel/ (according to them around 165 B.C.), claim that
(1) \x/Darius/ Medes 
\insertCite A\left\
...
The tenability of the Maccabean date hypothesis therefore depends on the above explanation of \uv{\x/Darius/ the Mede} (since according to this explanation the Median kingdom pre-dates the Persian kingdom).
...
\begitems \style n
%* \x/Darius/ I. byl rodem Peršan, bratranec krále \x/Cýra/; nebyl to v žádném případě Méd.
%\insertCite A\right
...
%\insertCite A\right
* \x/Darius/ I was a young man of about twenty when he murdered the impostor Gaumata (who claimed to be \x/Cyrus/'s son Smerdis) in 522 BC.  He could not have been 62 (\<5:31>). 
...
Nevertheless, we can identify \x/Darius/ the Mede.
...
Similarly, in verse \<5:31> we read that \x/Darius/ \uv{\x/took the kingdom/} (\uv{qabbel} \Qabbel), as if it had been conferred on him by a higher authority.
...
This scenario is supported by the text of the book in that \x/Daniel/ nowhere mentions any later year of \x/Darius/'s reign than \uv{first} (<9:1>), indicating its very short duration.
Even if this were to mean that the one-year reign belonged to the Medes (we know it did not; it belonged to Persian \x/Cyrus/), a one-year empire could hardly have defended its legitimate
